...
function HomepageHeader() {
  ...
  return (
    ...
    >
      <div style={{backgroundColor:"rgb(10, 39, 43,0.4)",height:"100%",width:"100%",color:"white !important","padding-top":"40px","padding-bottom":"40px"}}>
...
const teamList = [
  {src:"img/team/morgane.png","name":"Morgane Gonon","role":"Co-Présidente","contact":"https://www.linkedin.com/in/morgane-gonon-861879106/"},
  {src:"img/team/cesar.png","name":"César Dugast","role":"Co-Présidente","contact":"https://www.linkedin.com/in/c%C3%A9sar-dugast-18000463/"},
  {src:"img/team/oriane.png","name":"Oriane Wegner","role":"Co-Présidente","contact":"https://www.linkedin.com/in/orianewegner/"},
  {src:"img/team/alexandre.png","name":"Alexandre Joly","role":"Co-Présidente","contact":"https://www.linkedin.com/in/alexandre-joly-2a1a7869/"},
  {src:"img/team/lou.png","name":"Lou Welgryn","role":"Co-Présidente","contact":"https://www.linkedin.com/in/lou-welgryn-460434b0/"},
  {src:"img/team/guillaume.png","name":"Guillaume Kerlero de Rosbo","role":"Co-Présidente","contact":"https://www.linkedin.com/in/guillaume-kerlero-de-rosbo-8369a133/"},
  {src:"img/team/antoine.png","name":"Antoine Crépel","role":"Co-Présidente","contact":"https://www.linkedin.com/in/antoinecrepel/"},
  {src:"img/team/theo.png","name":"Théo Alves Da Costa","role":"Co-Président","contact":"https://www.linkedin.com/in/th%C3%A9o-alves-da-costa-09397a82/"},
]
        ...
        <section>
          <div className="container main-section">
            ...
            <div className="row">
              ...
              <div className="col col--6 supercenter" style={{"text-align":"left","align-content":"center"}}>
                <p><i>éclaircies</i> est un collectif <b>d’experts bénévoles, tous spécialistes des enjeux écologiques, énergétiques et climatiques</b>. Convaincus qu’en démocratie, faire évoluer le système passe par un bon niveau d’information des citoyens et de leurs représentants politiques, nous avons pour objectif d’éclairer le débat public en mettant à disposition de la société civile (décideurs, individus consommateurs ou électeurs, territoires, etc.) de l’information qualifiée et des outils qui permettent d’y voir plus clair dans un océan d’informations parfois contradictoires.</p>
              </div>
            </div>
          </div>
        </section>
